...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
          ...
          title: "repositories",
          description: "My code and statistics projects.",
          section: "Navigation",
          handler: () => {
        ...
        handler: () => {
          ...
          section: "Books",handler: () => {
            ...
            },},{id: "books-the-redemption-of-time",
          title: 'The Redemption of Time',
          description: "",
          section: "Books",handler: () => {
              window.location.href = "/books/redemption_of_time/";
        ...
        section: 'Socials',
        handler: () => {
          window.open("/assets/pdf/cv_beta.pdf", "_blank");
        },
      },{
        id: 'social-email',
        title: 'email',
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://github.com/Ju-Ortega", "_blank");
        },
      },{
        id: 'social-linkedin',
        title: 'LinkedIn',
